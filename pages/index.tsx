...
>) {
  return (
    <a
      ...
      className={`${
        className || ''
      } text-accent hover:text-back hover:bg-content transition`}
    >
      {children}
    </a>
  );
      ...
      <div className="flex justify-center w-full text-sm bg-back text-[1.25em] sm:text-[1.3em]">
        <div className="flex flex-col items-start justify-center leading-9 gap-y-4 my-[4em] mx-[2em] sm:m-16 max-w-2xl text-content font-[klima-web]">
          ...
          <p className="text-[0.01em]">
            ...
            a teen interested in a community of other teens in computer science
            or tech in general, you should join{' '}
            <Link href="https://hackclub.com">Hack Club!</Link>
          </p>
        </div>
      </div>
